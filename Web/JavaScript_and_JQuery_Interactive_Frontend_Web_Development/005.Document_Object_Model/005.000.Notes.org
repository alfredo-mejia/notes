...
** Section 5.6: Chapter Exercise
   ...
   - Our todo-list will have the following features:
     ...
     3. Change the background color of the item
     4. Change the position of the item (either move it up the list or move it down the list)
     5. Keep track of recently deleted items
     6. Count the amount of active items and display it in the header
